...
!(function(e, t, n) {
	...
	function i(e) {
		...
		Modernizr._config.enableClasses &&
			((t += ' ' + n + e.join(' ' + n)),
			E ? (T.className.baseVal = t) : (T.className = t))
	}
	function s(e, t) {
		if ('object' == typeof e) for (var n in e) O(e, n) && s(n, e[n])
		else {
			e = e.toLowerCase()
			var r = e.split('.'),
				o = Modernizr[r[0]]
	...
	function u(e, n, r, o) {
		...
		return (
			...
			(s = n(c, e)),
			p.fake
				? (p.parentNode.removeChild(p), (T.style.overflow = f), T.offsetHeight)
	...
	function A(e, t, o, i) {
		...
		for (
			var u, c, p, m, v, A = ['modernizr', 'tspan', 'samp'];
			!M.style && A.length;
	...
	Modernizr.addTest('objectfit', !!W('objectFit'), { aliases: ['object-fit'] }),
		o(),
		i(C),
		delete w.addTest,
